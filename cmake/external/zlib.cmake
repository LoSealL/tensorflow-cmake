...
if (systemlib_ZLIB)
  ...
  set(zlib_INCLUDE_DIR ${CMAKE_BINARY_DIR}/external/zlib_archive)
  ...
  set_target_properties(zlib_create_destination_dir PROPERTIES FOLDER "ExternalProjectTargets/zlib")
  set_target_properties(zlib_copy_headers_to_destination PROPERTIES FOLDER "ExternalProjectTargets/zlib")
