...
set(farmhash_INCLUDE_DIR ${CMAKE_BINARY_DIR}/external/farmhash_archive ${CMAKE_BINARY_DIR}/external/farmhash_archive/util)
...
if(WIN32)
  ...
  ExternalProject_Add(farmhash
      ...
      PATCH_COMMAND ${CMAKE_COMMAND} -E copy_if_different ${CMAKE_SOURCE_DIR}/cmake/patches/farmhash/CMakeLists.txt ${farmhash_BUILD}
...
set_target_properties(farmhash_create_destination_dir PROPERTIES FOLDER "ExternalProjectTargets/farmhash")
set_target_properties(farmhash_copy_headers_to_destination PROPERTIES FOLDER "ExternalProjectTargets/farmhash")
