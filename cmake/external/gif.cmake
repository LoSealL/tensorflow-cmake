...
set(gif_INCLUDE_DIR ${CMAKE_BINARY_DIR}/external/gif_archive/giflib-5.1.4/)
...
if(WIN32)
  ...
  ExternalProject_Add(gif
      ...
      PATCH_COMMAND ${CMAKE_COMMAND} -E copy_if_different ${CMAKE_SOURCE_DIR}/cmake/patches/gif/CMakeLists.txt ${gif_BUILD}
  ...
  ExternalProject_Add_Step(gif copy_unistd
      COMMAND ${CMAKE_COMMAND} -E copy_if_different
          ${CMAKE_SOURCE_DIR}/cmake/patches/gif/unistd.h ${gif_BUILD}/lib/unistd.h
      DEPENDEES patch
      DEPENDERS build
  )
...
set_target_properties(gif_create_destination_dir PROPERTIES FOLDER "ExternalProjectTargets/gif")
set_target_properties(gif_copy_headers_to_destination PROPERTIES FOLDER "ExternalProjectTargets/gif")
