...
set(png_INCLUDE_DIR ${CMAKE_BINARY_DIR}/external/png_archive)
...
if(WIN32)
  if(${CMAKE_GENERATOR} MATCHES "Visual Studio.*")
    ...
    if(CMAKE_BUILD_TYPE EQUAL Debug)
      set(png_STATIC_LIBRARIES 
        ${CMAKE_CURRENT_BINARY_DIR}/png/install/lib/libpng16_staticd.lib)
    else()
      set(png_STATIC_LIBRARIES 
        ${CMAKE_CURRENT_BINARY_DIR}/png/install/lib/libpng16_static.lib)
    endif()
  endif()
else()
...
set_target_properties(png_create_destination_dir PROPERTIES FOLDER "ExternalProjectTargets/png")
set_target_properties(png_copy_headers_to_destination PROPERTIES FOLDER "ExternalProjectTargets/png")
