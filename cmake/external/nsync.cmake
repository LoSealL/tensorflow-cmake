...
set(nsync_INCLUDE_DIR ${CMAKE_BINARY_DIR}/external/nsync/public)
...
ExternalProject_Add(nsync
    ...
    PATCH_COMMAND ${CMAKE_COMMAND} -E copy_if_different ${CMAKE_SOURCE_DIR}/cmake/patches/nsync/CMakeLists.txt ${nsync_BUILD}
...
file(GLOB nsync_cp_headers ${nsync_INSTALL}/include/*.h)
add_custom_command(TARGET nsync_copy_headers_to_destination PRE_BUILD
    COMMAND ${CMAKE_COMMAND} -E copy_if_different ${nsync_cp_headers} ${nsync_INCLUDE_DIR}/)

set_target_properties(nsync_create_destination_dir PROPERTIES FOLDER "ExternalProjectTargets/nsync")
set_target_properties(nsync_copy_headers_to_destination PROPERTIES FOLDER "ExternalProjectTargets/nsync")
