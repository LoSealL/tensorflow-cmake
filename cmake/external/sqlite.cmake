...
set(sqlite_INCLUDE_DIR ${CMAKE_BINARY_DIR}/external/sqlite)
...
if (WIN32)
    ExternalProject_Add(sqlite
        ...
        PATCH_COMMAND ${CMAKE_COMMAND} -E copy_if_different ${CMAKE_SOURCE_DIR}/cmake/patches/sqlite/CMakeLists.txt ${sqlite_BUILD}
...
set_target_properties(sqlite_create_destination_dir PROPERTIES FOLDER "ExternalProjectTargets/sqlite")
set_target_properties(sqlite_copy_headers_to_destination PROPERTIES FOLDER "ExternalProjectTargets/sqlite")
