...
set(lmdb_INCLUDE_DIR ${CMAKE_BINARY_DIR}/external/lmdb)
...
ExternalProject_Add(lmdb
    ...
    PATCH_COMMAND ${CMAKE_COMMAND} -E copy_if_different
        ${CMAKE_SOURCE_DIR}/cmake/patches/lmdb/CMakeLists.txt ${lmdb_BUILD}
...
set_target_properties(lmdb_create_destination_dir PROPERTIES FOLDER "ExternalProjectTargets/lmdb")
set_target_properties(lmdb_copy_headers_to_destination PROPERTIES FOLDER "ExternalProjectTargets/lmdb")
