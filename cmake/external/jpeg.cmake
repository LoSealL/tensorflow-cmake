...
set(jpeg_INCLUDE_DIR ${CMAKE_BINARY_DIR}/external/jpeg_archive)
...
if (WIN32)
    ExternalProject_Add(jpeg
        ...
        PATCH_COMMAND ${CMAKE_COMMAND} -E copy_if_different ${CMAKE_SOURCE_DIR}/cmake/patches/jpeg/CMakeLists.txt ${jpeg_BUILD}
...
set_target_properties(jpeg_create_destination_dir PROPERTIES FOLDER "ExternalProjectTargets/jpeg")
set_target_properties(jpeg_copy_headers_to_destination PROPERTIES FOLDER "ExternalProjectTargets/jpeg")
